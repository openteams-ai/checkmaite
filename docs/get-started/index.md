...
* :material-connection:{ .lg .middle } [__Object Detection Workflow via API__ :octicons-arrow-right-24:](checkmaite_api_od.html)

    ---
    API access for Object Detection workflows.

* :material-connection:{ .lg .middle } [__Image Classification Workflow via API__ :octicons-arrow-right-24:](checkmaite_api_ic.html)

    ---
    API access for Image Classification workflows.

* :material-connection:{ .lg .middle } [__Remote Inference with Ray Serve__ :octicons-arrow-right-24:](checkmaite_ray_serve.html)
