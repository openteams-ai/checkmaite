...
The `JATIC Reference Implementation` exists to bring the JATIC products together in support common workflows. It is supported by all of the JATIC tool teams.
