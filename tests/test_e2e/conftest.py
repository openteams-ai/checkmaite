...
def reallabel_config_od():
    ...
    from jatic_ri.ui._panel_od.configurations.reallabel_app import RealLabelApp as RealLabelAppOD
...
def survivor_config_od():
    ...
    from jatic_ri.ui._panel_od.configurations.survivor_app import SurvivorAppOD
...
def survivor_config_ic():
    ...
    panel app"""
    # import inside the fixture to improve test startup time
    from jatic_ri.ui._panel_ic.configurations.survivor_app import SurvivorAppIC
