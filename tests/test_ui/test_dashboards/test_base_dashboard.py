...
from checkmaite.ui._common.base_app import DEFAULT_STYLING
from checkmaite.ui._common.base_dashboard import BaseTestbed
...
def test_basedashboard_multi_model(pipeline_config, request):
    ...
    assert not success
    assert "Task must be specified" in app.status_source.current_value
