...
def test_feasibility_teststage(mock_evaluate: MagicMock, dummy_model_od, dummy_dataset_od) -> None:
    """Test FeasibilityTestStage implementation"""

    # Creates Sequence[DummyObjectDetectionTarget] with length (batch_size) of 3
    target_batch: od.TargetBatchType = [dummy_dataset_od[i][1] for i in range(3)]
