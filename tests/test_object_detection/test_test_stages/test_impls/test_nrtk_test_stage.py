...
def test_nrtk_test_stage(
    use_stage_cache, dummy_model_od, dummy_dataset_od, dummy_metric_od, artifact_dir, test_config
) -> None:
    ...
    filename = create_deck(output, artifact_dir, "nrtk")
