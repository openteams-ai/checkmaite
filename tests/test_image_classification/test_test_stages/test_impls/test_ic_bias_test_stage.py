...
class TestICBiasCollectReportConsumables:
    ...
    def test_report_balance(self, dummy_dataset_ic, balance_outputs):
    ...
    def test_report_coverage(self, dummy_dataset_ic, coverage_outputs: dict[str, Any], tmpdir):
    ...
    def test_report_coverage_low_samples(self, dummy_dataset_ic, coverage_outputs: dict[str, Any], tmpdir):
        """
    ...
    def test_report_diversity(self, dummy_dataset_ic, diversity_outputs):
    ...
    def test_report_parity(self, dummy_dataset_ic, parity_outputs):
    ...
    def test_bias_gradient_pptx(
        self, dummy_dataset_ic, coverage_outputs, balance_outputs, diversity_outputs, parity_outputs
    ) -> None:
