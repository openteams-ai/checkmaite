...
from checkmaite.core.capability_core import Capability, CapabilityConfigBase, Number
from checkmaite.core.image_classification.models import SUPPORTED_MODELS as SUPPORTED_MODELS_IC
from checkmaite.core.image_classification.models import SUPPORTED_TORCHVISION_MODELS as SUPPORTED_TORCHVISION_MODELS_IC
from checkmaite.core.object_detection.models import SUPPORTED_MODELS as SUPPORTED_MODELS_OD
from checkmaite.core.object_detection.models import SUPPORTED_TORCHVISION_MODELS as SUPPORTED_TORCHVISION_MODELS_OD
from checkmaite.core.object_detection.models import SUPPORTED_VISDRONE_MODELS as SUPPORTED_VISDRONE_MODELS_OD
from checkmaite.core.report import _gradient as gd
from checkmaite.ui._common.base_app import AppStyling, BaseApp
from checkmaite.ui.dashboard_utils import (
...
class BaseTestbed(BaseApp):
    ...
    **params : dict[str, Any]
    ...
    def load_models_from_widgets(self) -> bool:  # pragma: no cover
        ...
        module = importlib.import_module(f"checkmaite.core.{self.task}.models")
    ...
    def load_datasets_from_widgets(self) -> bool:
        ...
        module = importlib.import_module(f"checkmaite.core.{self.task}.dataset_loaders")
    ...
    def load_metric_from_widget(self) -> bool:
        ...
        """
        metrics_module = importlib.import_module(f"checkmaite.core.{self.task}.metrics")
