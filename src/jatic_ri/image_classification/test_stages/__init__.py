...
# Test Stages
# Config and Outputs from common base classes
...
from jatic_ri._common.test_stages.impls.survivor_test_stage import SurvivorConfig, SurvivorOutputs
...
# Config classes (from image_classification specific implementations)
# Outputs classes (from image_classification specific implementations)
