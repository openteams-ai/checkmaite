...
from jatic_ri.ui._panel._common.dataset_analysis_app import DAConfigurationLandingPage
from jatic_ri.ui._panel._common.model_evaluation_configuration import MEConfigurationLandingPage
from jatic_ri.ui._panel.dashboards.dataset_analysis_dashboard import DatasetAnalysisDashboard
from jatic_ri.ui._panel.dashboards.model_evaluation_dashboard import ModelEvaluationTestbed
from jatic_ri.ui._panel_ic.configurations.nrtk_app import NRTKAppIC
...
from jatic_ri.ui._panel_od.configurations.nrtk_app import NRTKAppOD
...
from jatic_ri.ui._panel_od.configurations.xaitk_app import XAITKAppOD
...
class FullApp(BaseApp):
    """High level constructor for the fully integrated RI App
