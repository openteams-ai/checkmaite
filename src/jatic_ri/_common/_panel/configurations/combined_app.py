...
from jatic_ri._common._panel.configurations.dataset_analysis_configuration import DAConfigurationLandingPage
...
class FullApp(BaseApp):
    ...
    To view the app, deploy the script `/deploy/app.py via the terminal:
